...
# gene model annotation is from TAIR10 https://www.arabidopsis.org/download/index-auto.jsp?dir=%2Fdownload_files%2FGenes%2FTAIR10_genome_release%2FTAIR10_gff3
RepGene.file <- "./dataset/TAIR10_representative_gene_models.txt"
# Representative gene model list is from TAIR10 https://www.arabidopsis.org/download/index-auto.jsp?dir=%2Fdownload_files%2FGenes%2FTAIR10_genome_release%2FTAIR10_gene_lists
...
# Corrected poly A site for (-) strand:
...
#      the coding gene
# 5'UTR     CDS       3'UTR           Downstream
# -----===============------|<-----------140nt---------->|
#                     |<-------------------------------->| 
#                      the region for selected polyA site
